...
const Sidebar = ({ onNewChat }) => {
  ...
  // Get user mode from localStorage (set by ModeSelector)
  const userMode = localStorage.getItem('bfsi-user-mode') || 'client';
  const isClientMode = userMode === 'client';
  const isAgentMode = userMode === 'agent';
  ...
  return (
    <div className={`sidebar dark-sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <nav className="nav-menu">
        <ul>
          {/* Chat - Only show for Client Mode */}
          {isClientMode && (
            <li>
              <Link
                to="/chat"
              ...
              >
                ...
                <span className="nav-text">My Application</span>
              </Link>
            </li>
          )}
          
          {/* Dashboard - Only show for Agent Mode */}
          {isAgentMode && (
            <li>
              <Link
                to="/dashboard"
          ...
          {/* Team Dashboard - Only show for Agent Mode */}
          {isAgentMode && (
            <li>
              <Link
                to="/team"
          ...
          {/* Settings - Only show for Agent Mode */}
          {isAgentMode && (
            <li>
              <Link
                to="/settings"
      ...
      <div className="sidebar-footer">
        ...
        <button 
          ...
          title="Switch between Client and Agent mode"
        >
